...
-- redefine global boats functions
boat.on_punch = function(self, puncher)
	...
	if not self.driver then
		...
		or not inv:contains_item("main", "nalc:"..self.parameters.name) then
			local leftover = inv:add_item("main", "nalc:"..self.parameters.name)
...
boat.on_step = function(self, dtime)
	...
	minetest.register_craftitem(
		"nalc:"..parameters.name,
		{
			...
			on_place = function(itemstack, placer, pointed_thing)
				...
				boat = minetest.add_entity(pointed_thing.under, "nalc:"..parameters.name)
				if boat then
