...
local function tnt_explode(pos, radius, ignore_protection, ignore_on_blast, no_fire) -- NALC: Ajout de no_fire pour explosions sans flammes
...
function tnt.boom(pos, def, is_mob) -- NALC: Ajout de is_mob. Si true alors explosion sans flammes
	minetest.sound_play("tnt_explode", {pos = pos, gain = 1.5, max_hear_distance = 2*64})
	minetest.set_node(pos, {name = "tnt:boom"})
	local drops, radius = tnt_explode(pos, def.radius, def.ignore_protection,
			def.ignore_on_blast, is_mob) -- NALC
	-- append entity drops
	...
	if is_mob then
		minetest.log("action", "A mob explosion occurred at " .. minetest.pos_to_string(pos) ..
							 " with radius " .. radius)
	else
